...
//	%+v:   error for internal read B - #0 [/home/robin/workspace/golang/src/github.com/robinlg/iam/main.go:12 (main.main)] (#100102) Internal Server Error; error for internal read A - #1 [/home/lk/workspace/golang/src/github.com/robinlg/iam/main.go:35 (main.newErrorB)] (#100104) Validation failed
...
//	%#+v:  [{"caller":"#0 /home/robin/workspace/golang/src/github.com/robinlg/iam/main.go:12 (main.main)","error":"error for internal read B","message":"(#100102) Internal Server Error"},{"caller":"#1 /home/lk/workspace/golang/src/github.com/robinlg/iam/main.go:35 (main.newErrorB)","error":"error for internal read A","message":"(#100104) Validation failed"}]
